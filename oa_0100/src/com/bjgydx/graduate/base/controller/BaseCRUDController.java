...
//import com.sbr.system.dao.ISystemUserDao;
//import com.sbr.system.service.IOperateLogService;
...
public abstract class BaseCRUDController<
	...
	protected static Log logger = LogFactory.getLog(BaseCRUDController.class);
	...
	protected abstract Pagination refreshData(Q queryForm);
...
//	}
	...
	@ResponseBody
	public Pagination query(Q queryForm) {
...
//		try {
//			beforeSave(entity);
//			returnEntity = baseService.saveOrUpdateAndView(entity);
//		} catch (Exception e) {
//			e.printStackTrace();
//			logger.error("系统异常: " + e , e.fillInStackTrace());
//			return createMessage(Boolean.FALSE, "保存失败！" + e.getMessage());
...
//	protected void beforeView(E savingEntity, Model model) throws ApplicationException {
//
//	}
//
//	// 在子类中重写此方法，在编辑时进行操作，如数据类型的转换，关联实体对象的转换
//	protected void beforeEdit(E savingEntity, Model model) throws ApplicationException {
//
//	}
//	
